...
class TestSheet(unittest.TestCase):
    ...
    def test_getNamedRange(self):
        self.assertIsNone(self.sheet.getNamedRange("foo", 0))
    ...
    def test_setNamedRange(self):
        self.assertTrue(self.sheet.setNamedRange("foo", 0, 10, 0, 10, 0))
        self.assertEqual(1, self.sheet.namedRangeSize())
        self.assertEqual( ("foo", 0, 10, 0, 10, 0, 0), self.sheet.namedRange(0) )

    def test_delNamedRange(self):
        self.assertFalse(self.sheet.delNamedRange('foo', 0))
        self.assertTrue(self.sheet.setNamedRange("foo", 0, 10, 0, 10, 0))
        self.assertTrue(self.sheet.delNamedRange('foo', 0))
